...
public class TestBikes {
  public static void main(String[] args){
    ...
    //Creating a child with a new Parent will not work (exception to this rule below)
    //MountainBike mbike01 = new Bicycle(20, 10, 1);
    ...
    //mbike2 = new Bicycle(20, 10, 1); //this will break
  }
}